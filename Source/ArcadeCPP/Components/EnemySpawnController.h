...
class ARCADECPP_API UEnemySpawnController : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	void StartSpawnStage();          // то кличество которое он будет спаунить  

	void SpawnEnemy();              //спавн  посредственно противников
